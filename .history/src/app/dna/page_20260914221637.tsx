...
export default function AgentDNAPage() {
  ...
  const handleResolve = (e: React.FormEvent) => {
    ...
    if (!cleanDid.startsWith("did:key:")) {
      botSpeak("Agent analysis failed: Invalid DID format. Expected 'did:key:z6Mk...'", "error", 5000);
      return;
    }
    const resolved = analyzeAgentDNA(cleanDid);
    setDna(resolved);
    ...
    botSpeak(`Agent DNA successfully synthesized: Class assigned as ${resolved.archetype.title}`, "success");
  };
  ...
  const playAgentVoice = () => {
    ...
    if (isPlayingAudio) {
      ...
      botSpeak("Harmonic acoustic frequency playback paused.", "info", 2500);
      return;
    }
    ...
    try {
      ...
      botSpeak("Synthesizing live cryptographic soundwave from DID multibase bytes...", "info", 3000);
      ...
      setIsPlayingAudio(false);
      botSpeak("Web Audio initialization error in browser sandbox.", "error");
    }
  };
  ...
  const downloadPassportImage = () => {
    ...
    link.click();
    botSpeak("Holographic passport exported as high-res PNG image.", "success");
  };
            ...
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-center">
                ...
                <div className="md:col-span-2 space-y-3">
                  <div className="p-3 bg-[#030712]/80 rounded-lg border border-[#162238]">
