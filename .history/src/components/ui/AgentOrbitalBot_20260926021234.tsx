...
import { AlertCircle, CheckCircle2, Info, AlertTriangle, Copy, Check } from "lucide-react";
...
export const AgentOrbitalBot: React.FC = () => {
  ...
  const getBorderColor = () => {
    ...
    if (currentEvent.type === "warning") return "border-amber-500/70 shadow-[0_0_35px_rgba(245,158,11,0.3)]";
  ...
  const getIcon = () => {
    ...
    if (currentEvent.type === "warning") return <AlertTriangle className="w-4 h-4 text-amber-400 flex-shrink-0" />;
